...
diabetes_model = pkl.load(open(r"C:\Users\HP\Downloads\projet_geek\geek\modelBS.pkl", 'rb') )
...
if st.button("Parkinson's Test Result"):
    ...
    parkinsons_prediction = diabetes_model.predict([[fo, fhi, flo, Jitter_percent, Jitter_Abs, RAP, PPQ, DDP, Shimmer,
